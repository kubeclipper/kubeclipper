...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeEtcd) DeepCopyInto(out *KubeEtcd) {
	*out = *in
	if in.Local != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeEtcd.
func (in *KubeEtcd) DeepCopy() *KubeEtcd {
	if in == nil {
		return nil
	}
	out := new(KubeEtcd)
