...
func NewCmdDeploy(streams options.IOStreams) *cobra.Command {
	...
	cmd.Flags().BoolVar(&o.deployConfig.AuthenticationOpts.AuthenticateRateLimiterEnable, "authenticate-rate-limiter-enable", o.deployConfig.AuthenticationOpts.AuthenticateRateLimiterEnable, "enable the login authentication rate limiter")
