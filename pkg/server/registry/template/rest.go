...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.StandardStorage, error) {
	...
	store := &genericregistry.Store{
		...
		NewListFunc: func() runtime.Object {
			return &v1.TemplateList{}
		},
		DefaultQualifiedResource: v1.Resource("templates"),
		KeyRootFunc:              nil,
		KeyFunc:                  nil,
		ObjectNameFunc:           nil,
		TTLFunc:                  nil,
		PredicateFunc:            MatchTemplate,
		...
		TableConvertor:           rest.NewDefaultTableConvertor(v1.Resource("templates")),
