...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.StandardStorage, error) {
	...
	store := &genericregistry.Store{
		NewFunc: func() runtime.Object {
			return &v1.CloudProvider{}
		},
		NewListFunc: func() runtime.Object {
			return &v1.CloudProviderList{}
		},
		DefaultQualifiedResource: v1.Resource("cloudproviders"),
		KeyRootFunc:              nil,
		KeyFunc:                  nil,
		ObjectNameFunc:           nil,
		TTLFunc:                  nil,
		...
		TableConvertor:           rest.NewDefaultTableConvertor(v1.Resource("cloudproviders")),
