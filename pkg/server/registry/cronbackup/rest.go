...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.StandardStorage, error) {
	...
	store := &genericregistry.Store{
		NewFunc: func() runtime.Object {
			return &v1.CronBackup{}
		},
		NewListFunc: func() runtime.Object {
			return &v1.CronBackupList{}
		},
		DefaultQualifiedResource: v1.Resource("cronbackups"),
		KeyRootFunc:              nil,
		KeyFunc:                  nil,
		ObjectNameFunc:           nil,
		TTLFunc:                  nil,
		...
		TableConvertor:           rest.NewDefaultTableConvertor(v1.Resource("cronbackups")),
