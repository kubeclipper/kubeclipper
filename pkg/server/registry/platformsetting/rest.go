...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.StandardStorage, error) {
	...
	store := &genericregistry.Store{
		...
		NewListFunc: func() runtime.Object {
			return &v1.PlatformSettingList{}
		},
		DefaultQualifiedResource: v1.Resource("platformsettings"),
		KeyRootFunc:              nil,
		KeyFunc:                  nil,
		ObjectNameFunc:           nil,
		TTLFunc:                  nil,
		...
		TableConvertor:           rest.NewDefaultTableConvertor(v1.Resource("platformsettings")),
