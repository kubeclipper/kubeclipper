...
func NewStorage(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (rest.StandardStorage, error) {
	...
	store := &genericregistry.Store{
		NewFunc: func() runtime.Object {
			return &v1.LoginRecord{}
		},
		NewListFunc: func() runtime.Object {
			return &v1.LoginRecordList{}
		},
		DefaultQualifiedResource: v1.Resource("loginrecords"),
		KeyRootFunc:              nil,
		KeyFunc:                  nil,
		ObjectNameFunc:           nil,
		TTLFunc:                  nil,
		PredicateFunc:            MatchLoginRecord,
		...
		TableConvertor:           rest.NewDefaultTableConvertor(v1.Resource("loginrecords")),
