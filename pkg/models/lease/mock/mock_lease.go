...
// ListLeasesEx mocks base method
func (m *MockOperator) ListLeasesEx(ctx context.Context, query *query.Query) (*models.PageableResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLeasesEx", ctx, query)
	ret0, _ := ret[0].(*models.PageableResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListLeasesEx indicates an expected call of ListLeasesEx
func (mr *MockOperatorMockRecorder) ListLeasesEx(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLeasesEx", reflect.TypeOf((*MockOperator)(nil).ListLeasesEx), ctx, query)
}
...
// ListLeasesEx mocks base method
func (m *MockLeaseReader) ListLeasesEx(ctx context.Context, query *query.Query) (*models.PageableResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLeasesEx", ctx, query)
	ret0, _ := ret[0].(*models.PageableResponse)
	ret1, _ := ret[1].(error)
...
// ListLeasesEx indicates an expected call of ListLeasesEx
func (mr *MockLeaseReaderMockRecorder) ListLeasesEx(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLeasesEx", reflect.TypeOf((*MockLeaseReader)(nil).ListLeasesEx), ctx, query)
}
...
// ListLeasesEx mocks base method
func (m *MockLeaseReaderEx) ListLeasesEx(ctx context.Context, query *query.Query) (*models.PageableResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListLeasesEx", ctx, query)
	ret0, _ := ret[0].(*models.PageableResponse)
	ret1, _ := ret[1].(error)
...
// ListLeasesEx indicates an expected call of ListLeasesEx
func (mr *MockLeaseReaderExMockRecorder) ListLeasesEx(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListLeasesEx", reflect.TypeOf((*MockLeaseReaderEx)(nil).ListLeasesEx), ctx, query)
}
