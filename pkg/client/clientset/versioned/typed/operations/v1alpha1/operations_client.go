...
type OperationsV1alpha1Interface interface {
	...
	OperationsGetter
	OperationTasksGetter
}

// OperationsV1alpha1Client is used to interact with features provided by the operations.kubeclipper.io group.
type OperationsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OperationsV1alpha1Client) Operations() OperationInterface {
	return newOperations(c)
}

func (c *OperationsV1alpha1Client) OperationTasks() OperationTaskInterface {
	return newOperationTasks(c)
}
